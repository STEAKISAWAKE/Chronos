...
Vulkan_Pipeline::Vulkan_Pipeline(RenderDevice* renderDevice, Shader* vShader, Shader* fShader)
{
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float) vulkanRenderDevice->swapChainExtent.width;
    viewport.height = (float) vulkanRenderDevice->swapChainExtent.height;
    viewport.minDepth = 0.0f;
    viewport.maxDepth = 1.0f;

    VkRect2D scissor = {};
    scissor.offset = {0, 0};
    scissor.extent = vulkanRenderDevice->swapChainExtent;
    ...
    VULKAN_CHECK(
        vkCreatePipelineLayout(vulkanRenderDevice->device, &pipelineLayoutInfo, nullptr, &pipelineLayout),
    ...
    pipelineInfo.renderPass = vulkanRenderDevice->renderPass;
    pipelineInfo.subpass = 0;
    pipelineInfo.basePipelineHandle = VK_NULL_HANDLE;
    pipelineInfo.basePipelineIndex = -1;

    VULKAN_CHECK(
        vkCreateGraphicsPipelines(vulkanRenderDevice->device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline),
